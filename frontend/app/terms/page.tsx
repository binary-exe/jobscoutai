        ...
        <div className="container mx-auto max-w-3xl px-4 py-12">
          ...
          <div className="prose prose-neutral dark:prose-invert max-w-none space-y-8 text-sm">
            <section>
              ...
              <p>
                {PRODUCT_NAME} is a product and service operated by <strong>{OPERATOR_LEGAL_NAME}</strong> (doing business as {BRAND_NAME}). &quot;We&quot;, &quot;us&quot;, and &quot;the Service&quot; refer to {OPERATOR_LEGAL_NAME} and the {PRODUCT_NAME} product. These Terms &amp; Conditions govern your use of the {PRODUCT_NAME} website and services available at {WEBSITE_URL}.
              </p>
            </section>
