...
import { PRODUCT_NAME, OPERATOR_LEGAL_NAME, SUPPORT_EMAIL, WEBSITE_URL } from '@/lib/legal';
      ...
      <main className="flex-1">
        <div className="container mx-auto max-w-3xl px-4 py-12">
          ...
          <p className="text-muted-foreground mb-8">
            Guidelines and ranges for teams and organizations. Operated by {OPERATOR_LEGAL_NAME}.
          </p>
          ...
          <div className="prose prose-neutral dark:prose-invert max-w-none space-y-6 text-sm">
            <section>
              ...
              <p>
                Custom and enterprise plans are for teams, career centers, bootcamps, or organizations that need higher volume, dedicated support, or custom terms. Standard self-serve plans are on our{' '}
                <Link href="/pricing" className="text-primary underline">Pricing</Link> page.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li><strong>Enterprise (100+ users):</strong> Custom quote; contact us with headcount and requirements.</li>
              </ul>
              <p className="mt-3 text-muted-foreground">
                All custom/enterprise pricing is quoted in USD unless otherwise agreed. Volume discounts and annual commitments can reduce effective per-seat or per-pack cost.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                Custom and enterprise plans can include: higher Apply Pack quotas, extended application tracking limits, DOCX exports, Trust Reports, and plan customization based on requirements. Exact deliverables are defined in the quote or order form.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                Email us at <a href={`mailto:${SUPPORT_EMAIL}`} className="text-primary underline">{SUPPORT_EMAIL}</a> with your organization name, approximate number of users or expected Apply Pack volume, and any requirements. We can send a formal quote and, on request, a downloadable pricing sheet (HTML/PDF) for your procurement or finance team.
              </p>
              <p className="mt-2">
                You can also view our printable pricing sheet at{' '}
                <Link href="/enterprise-pricing" className="text-primary underline">/enterprise-pricing</Link>.
              </p>
            </section>

            <section className="rounded-lg border border-border bg-muted/30 p-4">
              <p className="text-xs text-muted-foreground">
                This page is an official reference for custom and enterprise pricing guidelines. You may share this URL ({WEBSITE_URL}/pricing/enterprise) or export it to PDF and email it to partners or reviewers (e.g. Paddle domain review).
              </p>
            </section>
          </div>
