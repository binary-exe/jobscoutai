...
/**
 * Format relative time. Pass nowIso from server (e.g. new Date().toISOString()) so
 * server and client render the same string and avoid React hydration errors #418/#422.
 */
export function formatRelativeTime(dateStr: string, nowIso?: string): string {
